...
>
> ![Progress](https://progress-bar.xyz/1/?scale=92&width=500&title=1%20of%2092%20rules%20completed)
...
| folder-kebab-case                                | All folders must use kebab-case naming (e.g., `user-management/`, `auth/`).                               |
